                    ...
                    splashEventTimes.forEach(function(element){
                        element.times.forEach(function(times){
                            ...
                            if (timesCheckTime === sliderTime){
                                ...
                                $("#sliderEvents").append(`<a><div class="eventList event-name" value=${element.id}><div><p>${times}</p><p>${element.name}</p></div></a><button class="schedule-add btn-xs">Add to Schedule</button></div>`);
